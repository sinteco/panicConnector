      ...
      <div className="row">
        <div className="col-md-8 m-auto">
          ...
          <form onSubmit={this.onSubmit}>
            ...
            <div className="form-group">
              <input type="password" className={classnames('form-control form-control-lg',{'is-invalid':errors.confpassword})} placeholder="Confirm Password" name="confpassword" value={this.state.confpassword} onChange={this.onChange} />
...
export default connect(mapStateToProps, {registeruser})(withRouter(Regsiter));